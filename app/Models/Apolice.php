...
class Apolice extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Corretor::class, 'corretor_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Beneficio::class, 'apolice_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Cobertura::class, 'apolice_id', 'id');
    }
}
