...
/**
 * Class MedsafeBeneficioRepository
 * @package App\Repositories
 * @version August 13, 2019, 6:16 pm UTC
 *
 * @method MedsafeBeneficio findWithoutFail($id, $columns = ['*'])
 * @method MedsafeBeneficio find($id, $columns = ['*'])
 * @method MedsafeBeneficio first($columns = ['*'])
*/
class MedsafeBeneficioRepository extends BaseRepository
{
    /**
     * @var array
     */
