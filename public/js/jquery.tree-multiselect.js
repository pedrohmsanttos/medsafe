...
Tree.prototype.createSearchBar = function (parentNode) {
  ...
  var searchNode = Util.dom.createNode('input', { class: 'search form-control', placeholder: 'Buscar...' });
...
Tree.prototype.createSelectAllButtons = function (parentNode) {
  var selectAllNode = Util.dom.createNode('span', { class: 'btn btn-primary select-all', text: this.params.selectAllText });
  var unselectAllNode = Util.dom.createNode('span', { class: 'btn btn-primary unselect-all', text: this.params.unselectAllText });
