...
@section('content')
                    ...
                    <div class="row table-responsive">
                        <table class="table" id="filtros">
                            <thead>
                                ...
                                <th>
                                @if(count($filters) > 0)
                                    <a href="/pedidoTipoProdutos" class="btn btn-primary waves-effect">Limpar</a>
                                @endif
                                </th>
                            </thead>
                            <tbody>
    ...
    <div class="card">
        <div class="header">
            <div class="row">
                ...
                <ul class="header-dropdown ">
                     <li>
                        <a class="btn btn-success waves-effect pull-right" style="margin-top:-10px;margin-right: 10px;" href="{!! route('pedidoTipoProdutos.create') !!}">Adicionar novo</a>
                    </li>
                    <li class="dropdown">
        ...
        <div class="body">
            @include('pedido_tipo_produtos.table')
            <div class="row">
                <div class="col-md-6">
    ...
    <script>
        ...
        $(".gridBody td").click(function(){
            if(!$(this).hasClass('checkItem')){
                ...
                window.location = 'pedidoTipoProdutos/'+$( this ).parent().data( "id" )+'/edit'
            }
        });
        ...
        $('#editar').on('click', function(){
            ...
            if($('.checkbox:checked').length < 2 && $('.checkbox:checked').length > 0){
                window.location = 'pedidoTipoProdutos/'+$('.checkbox:checked')[indice].value+'/edit'
            }else{
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        $.each($("input:checked"), function(){            
                            if($(this).val() != 'on'){
                                pedido_tipo_produtos.push($(this).val());
                            }
                        });
                        ...
                        swal("Cancelado", "Seus pedidos não foi(ram) excluídos(s) :)", "error");
                    }
                });
            }else{
