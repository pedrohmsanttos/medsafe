            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r-0">
                        <li>
                            <a href="{{ url('relatorio/tesouraria') }}">
                                Voltar
                            </a>
                        </li>
                    </ul>
                ...
                <div class="body">
                    ...
                    <style>.dt-buttons{padding-bottom: 15px;}</style>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                @if(!empty($tesourarias))
                                    @foreach($tesourarias as $tesouraria)
                                        <tr>
                                            <td>{{ $tesouraria->getDataEmissao() }}</td>
                                            <td>{{ (!is_null($tesouraria->cliente_id)) ? $tesouraria->cliente()->first()->nomeFantasia : "" }}</td>
                                            <td>{{ (!is_null($tesouraria->fornecedor_id)) ? $tesouraria->fornecedor()->first()->nomeFantasia : "" }}</td>
