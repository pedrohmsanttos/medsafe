        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    {!! Form::open(['url' => '/relatorio/ativacoesPeriodo']) !!}
                        <div class="row">
                            <!-- Cliente Id Field -->
                            <!-- <div class="col-md-6">
                                <div class="form-group">
                                    {!! Form::label('usuario', 'Usuários:') !!}
                                    <div class="form-line {{$errors->has('usuario') ? 'focused error' : '' }}">
                                        <select id="usuario" name="usuario" class="form-control show-tick" data-live-search="true" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <a href="{!! url('/relatorio/ativacoesPeriodo') !!}" class="btn btn-default">Limpar</a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
