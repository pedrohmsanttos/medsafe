                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <select id="campo">
                            ...
                            <option value="nomeTitular">Nome Titular</option>
                            <option value="CNPJCPF">CNPJ/CPF</option>
                            <!-- <option value="classificacao">Classificação</option>
                            <option value="tipoPessoa">Tipo Pessoa</option>
                            <option value="inscricaoEstadual">Inscrição Estadual</option>
                            <option value="inscricaoMunicipal">Inscrição Municipal</option> 
                ...
                <div class="row table-responsive">
                    <table class="table" id="filtros">
                        <thead>
                            ...
                            <th>
                            @if(count($filters) > 0)
                                <a href="/fornecedores" class="btn btn-primary waves-effect">Limpar</a>
                            @endif
                            </th>
                        </thead>
                        <tbody>
