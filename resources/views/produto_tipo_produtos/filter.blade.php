                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <select id="campo">
                            ...
                            <option value="tipo">Tipo Produto</option>
                            <option value="categoria">Categoria Produto</option>
                        </select>
                    </div>
                ...
                <div class="row table-responsive">
                    <table class="table" id="filtros">
                        <thead>
                            ...
                            <th>
                            @if(count($filters) > 0)
                                <a href="/produtoTipoProdutos" class="btn btn-primary waves-effect">Limpar</a>
                            @endif
                            </th>
                        </thead>
                        <tbody>
