...
@include('seguradoras.filter')

<div class="card">
    <div class="header">
        <div class="row">
            <div class="col-md-10">
                <h2>Lista de Seguradora</h2>
            </div>
            <ul class="header-dropdown ">
                    <li>
                        <a class="btn btn-success waves-effect pull-right" style="margin-top:-10px;margin-right: 10px;" href="{!! url('seguradoras/create') !!}">Adicionar</a>
                    </li>
                <li class="dropdown">
    ...
    <div class="body">
        @include('seguradoras.table')
        <div class="row">
            <div class="col-md-6">
                <p style="margin-top: 25px;">Mostrando página {{ $seguradoras->currentPage() }} de {{ $seguradoras->lastPage() }} página(s), total de {{ $seguradoras->total() }} registros <p id="selecionados"></p> </p>
            </div>
    ...
    <script>
        ...
        $(".gridBody td").click(function(){
            if(!$(this).hasClass('checkItem')){
                ...
                window.location = 'seguradoras/'+$( this ).parent().data( "id" )+'/edit'
            }
        });
        ...
        $("#campo").change(function(){
            if($(this).val() == "CNPJ" || $(this).val() == "telefone"){
        ...
        $('#editar').on('click', function(){
            ...
            if($('.checkbox:checked').length < 2 && $('.checkbox:checked').length > 0){
                window.location = 'seguradoras/'+$('.checkbox:checked')[indice].value+'/edit'
            }else{
        ...
        $('#deletar').on('click', function(){
            ...
            if($('.checkbox:checked').length > 0){
                ...
                swal({
                    ...
                    text: "Toda(s) a(s) seguradora(s) inativa(s) perderá(ão) o acesso ao sistema!",
                    type: "warning",
                        ...
                        var request = $.ajax({
                            ...
                            success: function(result){
                                ...
                                if(result.msg == 'Sucesso'){
                                    ...
                                    swal("Erro", "Não foi possivel inativar as seguradoras selecionados", "error");
                                }
                            }
                        });

                    } else {
                        swal("Cancelado", "Suas seguradoras não foram inativadas", "error");
                    }
                });
            }else{
